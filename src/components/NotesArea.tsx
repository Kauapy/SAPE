    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Suas Anotações</h1>
            <p className="text-gray-600">Organize seus estudos e mantenha suas notas sempre à mão</p>
          </div>
